...
Your computer starts listening for incoming Requests.

At that moment, your machine becomes a Server.
...
Understand the difference between a Server and a Web Server.
...
Understand why Backend frameworks such as ASP.NET Core are needed.
...
The application runs on your own machine.
...
The application runs on a public Server accessible by users.

---

### Cloud Hosting

The application runs on cloud platforms such as:
...
Understand why Microsoft created Kestrel.
...
Understand why IIS is still used in Production.
...
# 📚 Lesson 07 — Nginx + Kestrel

## 🎯 Goal

Understand Linux hosting.
...
- Why Kestrel exists.
- Why ASP.NET Core no longer depends on IIS.
- The role of IIS and Nginx.
- How Requests travel in both Development and Production environments.
...
In the next Sprint, we'll dive inside Kestrel itself and answer questions such as:

- How does Kestrel start?
- What does "Listening on Port" actually mean?
- What are Sockets and Endpoints?
- How does Kestrel accept incoming connections?
- How is an HTTP Request transformed into an `HttpContext`?
- How does Kestrel send the HTTP Response back to the Client?
